...
### Referred Files
- {WORKSPACE}/src/ui/editors/SpecEditorProvider.ts
- {WORKSPACE}/src/ui/editors/TicketEditorProvider.ts
---
...
### Referred Files
- {WORKSPACE}/src/ui/editors/webview/components/Toolbar.svelte
- {WORKSPACE}/src/ui/editors/webview/SpecEditor.svelte
- {WORKSPACE}/src/ui/editors/webview/TicketEditor.svelte
---
...
### Referred Files
- {WORKSPACE}/src/ui/editors/webview/components/PreviewPanel.svelte
- {WORKSPACE}/src/ui/editors/webview/components/DiagramInserter.svelte
- {WORKSPACE}/src/ui/editors/SpecEditorProvider.ts
- {WORKSPACE}/src/ui/editors/TicketEditorProvider.ts
---